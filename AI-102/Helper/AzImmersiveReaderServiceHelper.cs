...
{
    public class AzImmersiveReaderServiceHelper
    {
        private readonly string _endpoint;
        private readonly string _key;

        public AzImmersiveReaderServiceHelper(IConfiguration config)
        {
            _endpoint = config["IMMERSIVE_READER_SERVICE_ENDPOINT"]
           ?? throw new ArgumentNullException("IMMERSIVE_READER_SERVICE_ENDPOINT is missing");

            _key = config["IMMERSIVE_READER_SERVICE_KEY"]
                ?? throw new ArgumentNullException("IMMERSIVE_READER_SERVICE_KEY is missing"); 
        }
